...
rank_networks[["Signif_withoutPPI"]] <-process_rank_network(all_diseases = diseases_to_consider,
                                                            el_all = el_all, 
                                                            weighted = T, 
                                                            disease_specific = T, 
                                                            to_exclude = c("ppi"))
...
rank_networks[["Signif_withoutCoPathway"]] <-process_rank_network(all_diseases = diseases_to_consider,
                                                            el_all = el_all, 
                                                            weighted = T, 
                                                            disease_specific = T, 
...
rank_networks[["Signif_withoutCoEsssential"]] <-process_rank_network(all_diseases = diseases_to_consider,
                                                            el_all = el_all, 
                                                            weighted = T, 
                                                            disease_specific = T, 
...
rank_networks[["Signif_withoutGO"]] <-process_rank_network(all_diseases = diseases_to_consider,
                                                            el_all = el_all, 
                                                            weighted = T, 
                                                            disease_specific = T, 
...
rank_networks[["Signif_withoutPhenotype"]] <-process_rank_network(all_diseases = diseases_to_consider,
                                                            el_all = el_all, 
                                                            weighted = T, 
                                                            disease_specific = T, 
                                                            to_exclude = c("HP, MP"))
...
rank_networks[["Signif_withoutCoEx"]] <-process_rank_network(all_diseases = diseases_to_consider,
                                                            el_all = el_all, 
                                                            weighted = T, 
                                                            disease_specific = T, 
